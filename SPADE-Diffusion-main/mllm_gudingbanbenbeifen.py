...
def get_params_dict(output_text):
    ...
    #prompt_match_r = re.search(r"Regional Prompt r: (.*?)(?=\n \n|\Z)", response, re.DOTALL)
    #if prompt_match:
    #    regional_prompt_r = prompt_match_r.group(1).strip()
    #    #print("Regional Prompt:", regional_prompt)
    #else:
    #    print("Regional Prompt r not found.")
    #image_region_dict = {'Final split ratio': final_split_ratio, 'Final split ratio r': final_split_ratio_r ,'Regional Prompt': regional_prompt}    
    image_region_dict = {'Final split ratio': final_split_ratio, 'Final split ratio r': final_split_ratio_r ,'Final split ratio all': final_split_ratio_all, 'Regional Prompt': regional_prompt} 
